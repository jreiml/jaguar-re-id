...
def build(out_path: Path) -> Path:
    ...
    eda_text = (
        ...
        "4-seed dedup study (E11): Δ = −0.006 ± 0.024 vs full train — within the E13 seed-noise floor, so exact-pHash dedup at 6.7 % of images is "
        "a <i>null</i> for retrieval (the original single-seed result of −0.034 was an outlier).<br/>"
